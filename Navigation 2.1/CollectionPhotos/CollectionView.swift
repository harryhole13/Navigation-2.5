...
//
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        self.addSubview(coollectionView)
        ...
        NSLayoutConstraint.activate([
            ...
            self.coollectionView.topAnchor.constraint(equalTo: self.topAnchor),
            self.coollectionView.heightAnchor.constraint(equalToConstant: collectionNeededHeight),
            self.coollectionView.trailingAnchor.constraint(equalTo: self.trailingAnchor),
            self.coollectionView.leadingAnchor.constraint(equalTo: self.leadingAnchor),
